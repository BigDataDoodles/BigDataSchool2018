...
public class PokeMapper extends Mapper<LongWritable, Text, Text, Text> {
    public void map(LongWritable key, Text pokemon, Context context) throws IOException {
        ...
        try{
            ...
            //TODO: Use constants instead of 2,3...
            String tipa = row[2];
            String name = row[1];
            ...
            //TODO: Why do you use String.valueOf?? Just hp, attack, .. is OK
            ...
            ///TODO: Don't catch exception, use more narrow exceptions (IOException)
        }catch (Exception e){
            e.printStackTrace();
        }
